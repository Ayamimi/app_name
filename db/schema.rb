...
ActiveRecord::Schema.define(version: 2022_06_01_164639) do
  ...
  create_table "bats", force: :cascade do |t|
    ...
    t.index ["post_id"], name: "index_bats_on_post_id"
    t.index ["user_id"], name: "index_bats_on_user_id"
  end
  ...
  create_table "outs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["comment_id"], name: "index_outs_on_comment_id"
    t.index ["post_id"], name: "index_outs_on_post_id"
  ...
  add_foreign_key "bats", "posts"
  add_foreign_key "bats", "users"
  add_foreign_key "comments", "posts"
  add_foreign_key "comments", "users"
  add_foreign_key "likes", "posts"
  add_foreign_key "likes", "users"
  add_foreign_key "outs", "comments"
  add_foreign_key "outs", "posts"
